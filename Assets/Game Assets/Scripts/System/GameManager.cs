...
namespace Slime
{
    public class GameManager : SingletonComponent<GameManager>
    {
        ...
        private void CheckUnlockAchievement()
        {
            ...
            {
                case 1:
                    AchievementManager.Instance.UnlockAchievement(GPGSIds.achievement_ready_to_go);
                    break;
                case 10:
                    AchievementManager.Instance.UnlockAchievement(GPGSIds.achievement_big_brain);
                    break;
                case 20:
                    AchievementManager.Instance.UnlockAchievement(GPGSIds.achievement_massive_brain);
                    break;
                default:
                    break;
            }
